...
<body>
    ...
    <section class="xs-section-padding contact-info-area" data-scrollax-parent="true">
                ...
                <div class="col-lg-6">
                    <div class="contact-info2">
                        <div class="agency-section-title">
                            <h3 class="sub-title">COLLEGE</h3>
                            <h4 class="main-title">Our <em>Location</em></h4>
                        </div>
                        <p>We work systematically to integrate corporate responsibility in our core education and make
                            our expertise available the benefit of the societies where we</p>
                        <ul class="contact-info-list">
                            <li>
                                <strong>Address</strong>
                                <div class="list-content">
                                    <a href="https://www.google.com/maps/search/Tinkonia+New+Market+(1ST+Floor),Goods+Shed+Road,Burdwan-1/@23.2461016,87.8670982,17z/data=!3m1!4b1?entry=ttu"
                                        target="_blank">Tinkonia New Market (1ST Floor),Goods Shed Road,Burdwan-1</a>
                                </div>
                            </li>
                            <li>
                                <strong>Phone</strong>
                                <div class="list-content">
                                    <a href="tel:+91%203422568909">+91 3422568909</a>
                                    <a href="tel:+91%203422568896">+91 3422568896</a>
                                </div>
                            </li>
                            <li>
                                <strong>Email</strong>
                                <div class="list-content">
                                    <a
                                        href="https://html.xpeedstudio.com/cdn-cgi/l/email-protection#aedfdbcbdcd7eed9cbccddc7dacb80cdc1c3"><span
                                            class="__cf_email__"
                                            data-cfemail="2d5c58485f546d5a484f5e445948034e4240">info@bcrti.co.in</span></a>
                                </div>
                            </li>
                            <li>
        ...
        <div class="doodle-parallax">
            <img src="<?php echo base_url() ?>assets/images/doodle/parallax-7.png"
                data-scrollax="properties: { translateY: '50%' }" class="single-doodle one" alt>
            <img src="<?php echo base_url() ?>assets/images/doodle/parallax-8.png"
                data-scrollax="properties: { translateY: '-50%' }" class="single-doodle two" alt>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="agency-section-title text-center style4">
                            ...
                            <p>Just ask what ever you want. We are trying to solve your query. Our Institute contact
                                with you within 24H .</p>
